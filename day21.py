...
def main():
    with open('/home/diego/Documents/Python/AdventCode/data_files/data_day21.txt') as file:
        codes = file.read().splitlines()
    part1_result = sum(int(code[:-1]) * find_shortest_sequence(code, proxies=2) for code in codes)
    print("Part 1 ->",part1_result)

    part2_result = sum(int(code[:-1]) * find_shortest_sequence(code, proxies=25) for code in codes)
